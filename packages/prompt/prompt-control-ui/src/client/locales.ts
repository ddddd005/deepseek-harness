export const en = {
  ...
  sources: 'Sources', preview: 'Preview request', previewEmpty: 'No preview loaded.', system: 'System', messages: 'Messages', tools: 'Tools',
...
export const zh: Record<PromptControlUiKey, string> = {
  ...
  sources: '来源', preview: '预览请求', previewEmpty: '尚未加载预览。', system: 'System', messages: '消息', tools: '工具',
