...
<a id="deepseek-aidsh-prompt-control"></a>

## `@deepseek-ai/dsh-prompt-control`

Requires: `systemPrompt` · `storageDomain` · `llm` · `sessions`
...
Source: [`packages/prompt/prompt-control/src/index.ts:550`](../packages/prompt/prompt-control/src/index.ts)
...
Source: [`packages/core/system-prompt/src/index.ts:343`](../packages/core/system-prompt/src/index.ts)
...
- `@deepseek-ai/dsh-prompt-control-ui` ([`packages/prompt/prompt-control-ui/src/index.ts`](../packages/prompt/prompt-control-ui/src/index.ts))
...
- `@deepseek-ai/dsh-prompt-control-web-profile` ([`packages/prompt/prompt-control-web-profile/src/index.ts`](../packages/prompt/prompt-control-web-profile/src/index.ts))
