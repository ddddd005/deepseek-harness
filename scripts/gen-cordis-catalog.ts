...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  CatalogContext: 'system-prompt.md',
  CatalogOptions: 'system-prompt.md',
  CatalogSection: 'system-prompt.md',
  CatalogVariable: 'system-prompt.md',
  PromptContext: 'system-prompt.md',
  PromptContextOrderName: 'system-prompt.md',
  PromptCatalog: 'system-prompt.md',
  PromptContributionId: 'system-prompt.md',
  PromptContributionLifetime: 'system-prompt.md',
  PromptContributionSource: 'system-prompt.md',
  ...
  ToolCatalog: 'tools.md',
  ToolCatalogOptions: 'tools.md',
